...
// Source: github.com/oriventi/simplebank/db/sqlc (interfaces: Store)
...
// LockAccountEntry mocks base method.
func (m *MockStore) LockAccountEntry(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LockAccountEntry", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LockAccountEntry indicates an expected call of LockAccountEntry.
func (mr *MockStoreMockRecorder) LockAccountEntry(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LockAccountEntry", reflect.TypeOf((*MockStore)(nil).LockAccountEntry), arg0, arg1)
}
